...
An attacker can access the `cgi_get_ipv6` interface **without any authentication**, leading to the disclosure of IPv6 network topology information.

The interface returns structured IPv6 configuration data, including link-local IPv6 addresses, interface modes and states, prefix information, gateway and DNS configuration. This information allows an attacker to infer the internal IPv6 network topology and interface layout of the device.
